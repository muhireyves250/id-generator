...
GlobalFonts.registerFromPath(path.join(__dirname, 'client/public/times.ttf'), 'Times');
GlobalFonts.registerFromPath(path.join(__dirname, 'client/public/times.ttf'), 'Arial');
GlobalFonts.registerFromPath(path.join(__dirname, 'client/public/AlexBrush-Regular.ttf'), 'AlexBrush');
...
async function generateCard2(params) {
    ...
    const templateImg = await loadImage('client/public/card.png');
    ...
    const defaultLogoImg = await loadImage('client/public/logo.png');
    const defaultStudentImg = await loadImage('client/public/student.png');
...
let colleges = {};
try {
    colleges = JSON.parse(fs.readFileSync(path.join(__dirname, 'client/public/collegeWa.json'), 'utf8'));
} catch (error) {
...
async function generateCard(params, set) {
    ...
    const templates1 = ['client/public/temp1.png', 'client/public/temp2.png', 'client/public/temp3.png',
        'client/public/temp4.png', 'client/public/temp5.png', 'client/public/temp6.png'];
    const templates2 = ['client/public/temp2_1.png', 'client/public/temp2_2.png', 'client/public/temp2_3.png',
        'client/public/temp2_4.png', 'client/public/temp2_5.png', 'client/public/temp2_6.png'];
    ...
    // clg logo
    const logoSrc = params.college_logo || 'client/public/college_logo.png';
    ...
    // stdnt pic
    const studentPhotoSrc = params.student_photo || 'client/public/default_student.png';
